...
import { Animated, Dimensions, Easing, Image, Text, View, StyleSheet, TouchableOpacity, ScrollView } from 'react-native';
...
const categoryTouts = [ //the touts are the clickable image items that hold our links
  { title: 'Category1', links: categoryLinks },
  { title: 'Category2', links: categoryLinks },
  { title: 'Category3', links: categoryLinks },
]
...
export default class scrollAccordion extends React.PureComponent { //scroll accordion is our parent class - it renders the touts and their subcategories
  ...
  measurements = []
  // categoryTouts = this.props.categoryTouts;
